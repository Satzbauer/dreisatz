...
using namespace std;
	...
	if(Bewertung=="gut")
	{
	cout << "ok, du bist ein positiver Typ, das gefällt mir!" << endl;
	std::cout << "Gib jetzt dein Thema in Form eines Substantivs (Sachworts) ein und ich gebe dir Sätze: " << std::endl;
	std::cin >> Begriff;
	...
	else if (Bewertung=="schlecht")
	{
		...
		std::cout << "Gib jetzt dein Thema in Form eines Substantivs (Sachworts) ein und ich gebe dir drei Sätze " << std::endl;
		std::cin >> Begriff;
		cout << Begriff << flush;
		...
		cout << " Ich hege Feindseligkeiten gegenüber so manchem Sachverhalt, der mit dem kritisch zu beäugelnden Wort " << flush;
		cout << Begriff << flush;
		cout << " zusammenhängt" << endl;
		cout << "Die Idee des Wortes " << flush;
		cout << Begriff << flush;
		cout << " bringt Missstände zustande, welche nicht nur in der Theorie, sondern auch in der realen Wirklichkeit ihr Unwesen treiben." << endl;
        system("pause");
    	}
	    
        else
	{
		cout << "Freud und Leid bestimmt das Dasein vieler Menschen. Doch du hast gerade etwas anderes im Sinn als dich zu freuen oder zu aergern. Das unterstütze ich!" << endl;
	    ...
	    cout << "Nähern wir uns aus lexikalischer- historischer- und praktischer Sicht dem Worte " << flush;
	    cout << Begriff << flush;
